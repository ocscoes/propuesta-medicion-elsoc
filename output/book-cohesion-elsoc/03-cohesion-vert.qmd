...
En momentos anteriores, el [Observatorio de Cohesión Social (OCS)](https://ocs-coes.com) ya ha concentrado sus esfuerzos en proponer un marco analítico de cohesión social vertical en base a lo planteado por @chan_reconsidering_2006, pero con un foco en el estudio de América Latina. Para ello, se utilizó la base de datos LAPOP y Latinobarómetro para construir la propuesta presentada en la @fig-ocs-la. Conceptualmente, este esquema se conforma mediante tres dimensiones: **Confianza en instituciones**, **actitudes hacia la democracia** y **justicia distributiva**.
...
### Esquema de cohesión vertical OCS 2021
...
## Propuesta de medición de cohesión longitudinal vertical (VisELSOC)

Con la idea de actualizar el marco analítico de la cohesión social, apuntando a una medición y operacionalización más pertinente, completa y fiable, se ha elaborado la siguiente @tbl-propuesta-nueva, donde se visualizan los indicadores contemplados, sus códigos y la disponibilidad en cada ola. La propuesta se presenta en la siguiente tabla.
...
La nueva propuesta del OCS se visualiza en @fig-ocs-nueva, conformándose a partir de cuatro dimensiones: Confianza en instituciones, prácticas y actitudes políticas, preferencias por sistema político y justicia distributiva. Esta propuesta se resume en el siguiente esquema:
...
```{r}
#| label: tbl-conf-cfa
#| tbl-cap: "Análisis Factorial Confirmatorio de Confianza en Instituciones (Ola 2023)"
#| tbl-subcap: 
#|   - "Resumen del Modelo"
#|   - "Índices de Ajuste"
...
```{r}
#| label: tbl-pol-cfa
#| tbl-cap: "Análisis Factorial Confirmatorio de Participación y Actitudes Políticas (Ola 2023)"
#| tbl-subcap: 
#|   - "Resumen del Modelo"
#|   - "Índices de Ajuste"
#|   - "Cargas Factoriales Estandarizadas"
...
```{r}
#| label: tbl-pref-cfa
#| tbl-cap: "Análisis Factorial Confirmatorio de Preferencias por Autoritarismo (Ola 2023)"
#| tbl-subcap: 
#|   - "Resumen del Modelo"
#|   - "Índices de Ajuste"
#|   - "Cargas Factoriales Estandarizadas"
...
```{r}
#| label: tbl-justicia-cfa
#| tbl-cap: "Análisis Factorial Confirmatorio de Justicia Distributiva (Ola 2023)"
#| tbl-subcap: 
#|   - "Resumen del Modelo"
#|   - "Índices de Ajuste"
#|   - "Cargas Factoriales Estandarizadas"
