...
plot_stackfrq(
  dplyr::select(db, reunion_pub, voluntariado,
...
2. _Satisfacción con el barrio_
```{r}
#| echo: false
#| warning: false
#| message: false
