...
# Contar frecuencias por ola, categoría de simpatía y sexo
...
# Graficar frecuencias en líneas, separando por sexo
ggplot(simpatia_sexo, aes(x = ola, y = freq, color = factor(simpatia_migrantes), group = simpatia_migrantes)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(title = "Frecuencia de simpatía hacia migrantes según sexo (ELSOC)",
       x = "Ola", 
       y = "Frecuencia",
