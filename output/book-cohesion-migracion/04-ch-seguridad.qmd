...
#| fig-align: "center"
db_pond %>% 
  select(wave, seguridad_sub, desempleo_migrantes) %>%
  mutate(seguridad_sub = case_when(
  ...
  group_by(desempleo_migrantes, seguridad_sub) %>%
  ...
  ggplot(aes(x = desempleo_migrantes, y = prop, fill = seguridad_sub)) +
