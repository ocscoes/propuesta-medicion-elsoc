...
desc_redes_sociales <- plot_stackfrq(
 ...
 labs(caption = "Fuente: elaboración propia con datos agrupados de ELSOC 2021")
...
```{r}
#| label: fig-prosoc
#| fig-cap: Comportamiento prosocial y desempleo debido a inmigrantes 
#| fig-cap-location: top
#| echo: false 
...
```{r}
#| label: fig-confinter
#| fig-cap: Confianza interpersonal y desempleo debido a inmigrantes
#| fig-cap-location: top
#| echo: false 
...
```{r}
#| label: fig-ayudaeco
#| fig-cap: Ayuda económica y desempleo debido a inmigrantes
#| fig-cap-location: top
#| echo: false 
...
ggplot(elsoc_5_graph_2, aes(
  ...
  geom_bar(position = "fill") +
  scale_fill_manual(
    values = c("Mucha ayuda" = "#2b2f3c", "Baja ayuda" = "#f9913d"),
    breaks = c("Baja ayuda", "Mucha ayuda"),
    name = "Categorías"
  ) +
  labs(
...
#| fig-cap: Confianza interpersonal y desempleo debido a inmigrantes por género
#| fig-cap-location: top
#| echo: false 
...
#| fig-cap: Confianza interpersonal y desempleo debido a inmigrantes por nivel educacional
#| fig-cap-location: top
#| echo: false 
...
## Migración y redes sociales en el tiempo
