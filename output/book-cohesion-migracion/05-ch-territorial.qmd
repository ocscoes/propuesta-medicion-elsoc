...
## Recodificaciones Vinculación Territorial
...
```{r}
#| label: fig-satbarrio
#| fig-cap: Percepción de pérdida de identidad del país debido a inmigrantes según satisfacción con el barrio
#| fig-cap-location: top
#| echo: false 
...
ggplot(elsoc_6_graph_2, aes(
  ...
  scale_fill_manual(
    ...
    breaks = c("Alta satisfacción", "Baja satisfacción"),
    name = "Categorías"
  ) +
  labs(
...
```{r}
#| label: fig-sentper
#| fig-cap: Percepción de pérdida de identidad del país \n debido a inmigrantes según sentido de pertenencia
#| fig-cap-location: top
#| echo: false 

ggplot(elsoc_6_graph_2, aes(
  x = sentido_pertenencia, 
...
#| fig-cap: Percepción de desempleo debido a inmigrantes y sentido de pertenencia por nivel educacional
#| fig-cap-location: top
#| echo: false 
