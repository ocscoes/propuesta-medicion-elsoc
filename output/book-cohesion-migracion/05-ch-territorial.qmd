...
Satisfaccion barrio y restriccion migrantes
```{r}
#| label: fig-satbarrio
#| echo: false
#| warning: false
...
ggplot(datos_porcentajes, aes(
  ...
  labs(
    title = "Percepción de pérdida de identidad y sentido de pertenencia",
...
ggplot(datos_porcentajes, aes(
  ...
  labs(
    title = "Percepción de desempleo debido a inmigrantes y sentido de pertenencia por nivel educativo",
